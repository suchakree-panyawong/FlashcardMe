...
const translations = {
  th: {
    ...
    meaningLabel: "ความหมายของคำ (ภาษาไทย)",
    ...
    navigateToCard: "ไปดูการ์ดนี้",
    duplicateImport: "ข้ามการ์ดคำซ้ำ",
    added: "เพิ่มใหม่",
    updated: "อัปเดต",
    skipped: "ข้าม",
    correctAnswers: "ตอบถูก",
    incorrectAnswers: "ตอบผิด",
    accuracy: "Accuracy",
    domainFilter: "Domain",
    allDomains: "ทุก Domain",
    neverStudied: "ยังไม่เคยเรียน",
    ...
    activeRecall: "ลองนึกคำตอบก่อนดูเฉลย",
    typeAnswer: "พิมพ์คำแปลหรือความหมาย...",
    checkAnswer: "ตรวจคำตอบ",
    correctAnswer: "ถูกต้อง ลองดูบริบทต่อได้เลย",
    tryAgain: "ยังไม่ตรง ลองดูเฉลยแล้วประเมินตัวเอง",
    importCsv: "นำเข้า CSV",
    exportCsv: "ส่งออก CSV",
    studyFocus: "โหมดทบทวน",
    allFocus: "ทั้งหมด",
    favoriteFocus: "รายการโปรด",
    mistakesFocus: "เคยตอบผิด",
    unseenFocus: "ยังไม่เคยเรียน",
    dailyGoal: "เป้าหมายวันนี้",
    cardsToday: "การ์ดวันนี้",
    notificationsTitle: "แจ้งเตือนการทบทวน",
    notificationsHint: "เตือนเมื่อมีการ์ดถึงกำหนด",
    enable: "เปิดใช้",
    ...
    reviewAgain: "ทวนอีกครั้ง",
    gettingThere: "กำลังจำได้",
    gotIt: "เข้าใจแล้ว",
    quickReview: "เร็ว",
    reviewInDays: "2-3 วัน",
    reviewInLongerDays: "5-7 วัน",
    tapToReveal: "แตะการ์ดเพื่อดูเฉลย",
    primaryMeaning: "คำแปลหลัก",
    additionalMeaning: "ความหมายเพิ่มเติม / การใช้งาน",
    showAdditionalMeaning: "ดูความหมายเพิ่มเติม",
    hideAdditionalMeaning: "ซ่อนความหมายเพิ่มเติม",
    ...
    speedRunTitle: "ทำลายสถิติ",
    speedRunReveal: "แตะเพื่อดูคำแปล",
    speedRunHint: "ตอบให้ไว แต่ไม่ต้องกดดันตัวเอง",
    speedRunComplete: "จบรอบทำลายสถิติแล้ว",
    speedRunPoints: "คะแนน",
    speedRunTimeouts: "ใบหมดเวลา",
    ...
    deckManagement: "จัดการชุดคำศัพท์",
    renameDeck: "เปลี่ยนชื่อชุด",
    renameDeckPrompt: "ใส่ชื่อชุดคำศัพท์ใหม่",
    renameDeckConfirm: "เปลี่ยนชื่อชุดคำศัพท์นี้ในการ์ดทั้งหมดหรือไม่?",
    renameDeckExists: "มีชุดคำศัพท์ชื่อนี้อยู่แล้ว",
    deckRenamed: "เปลี่ยนชื่อชุดคำศัพท์แล้ว",
    deckInsights: "ภาพรวมตามชุดคำศัพท์",
  ...
  en: {
    ...
    meaningLabel: "Word meaning (Thai)",
    ...
    navigateToCard: "View existing card",
    ...
    activeRecall: "Recall the answer before revealing it",
    typeAnswer: "Type the translation or meaning...",
    checkAnswer: "Check",
    correctAnswer: "Correct. Review the context next.",
    tryAgain: "Not quite. Check the answer and rate yourself honestly.",
    importCsv: "Import CSV",
    exportCsv: "Export CSV",
    studyFocus: "Study focus",
    allFocus: "All due cards",
    favoriteFocus: "Favorites",
    mistakesFocus: "Mistakes",
    unseenFocus: "Never studied",
    dailyGoal: "Daily goal",
    cardsToday: "cards today",
    notificationsTitle: "Review reminders",
    notificationsHint: "Get a reminder when cards are due",
    enable: "Enable",
    ...
    gotIt: "Got it",
    quickReview: "Quick",
    reviewInDays: "2-3 days",
    reviewInLongerDays: "5-7 days",
    tapToReveal: "Tap the card to reveal",
    primaryMeaning: "Primary meaning",
    additionalMeaning: "Additional meaning / usage",
    showAdditionalMeaning: "Show additional meaning",
    hideAdditionalMeaning: "Hide additional meaning",
    ...
    speedRunReveal: "Tap to reveal the meaning",
    speedRunHint: "Move quickly, but keep it light",
    speedRunComplete: "Speed Run complete",
    speedRunPoints: "points",
    speedRunTimeouts: "timed out",
    ...
    allDecks: "All decks",
    deckManagement: "Manage decks",
    renameDeck: "Rename deck",
    renameDeckPrompt: "Enter a new deck name",
    renameDeckConfirm: "Rename this deck across all of its cards?",
    renameDeckExists: "A deck with this name already exists",
    deckRenamed: "Deck renamed",
    deckInsights: "Deck overview",
